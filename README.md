...
> If you face any dependency or installation errors (for example, NumPy build issues),
> please recreate a virtual environment with Python 3.10 or 3.11 and run:
> '''
> py -3.11 -m venv venv
